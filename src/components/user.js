...
class User extends Emitter {
    ...
    constructor(chatEngine, uuid, state = {}) {
        ...
        this.feed = new this.chatEngine.Chat([chatEngine.global.channel, 'user', uuid, 'read.', 'feed'].join('_'), false, this.constructor.name === 'Me', {}, 'system');
        ...
        * });
         ...
         */
        this.direct = new this.chatEngine.Chat([chatEngine.global.channel, 'user', uuid, 'write.', 'direct'].join('_'), false, this.constructor.name === 'Me', {}, 'system');
